#ifndef DASH_SIMPLE_BLOCK_PATTERN_H_
#define DASH_SIMPLE_BLOCK_PATTERN_H_
...
>
class SimpleBlockPattern
{
public:
  static constexpr const char * PatternName = "SimpleBlockPattern";
...
private:
  ...
  typedef SimpleBlockPattern<NumDimensions, Arrangement, IndexType>
    self_t;
...
public:
  ...
  typedef struct {
    team_unit_t                           unit;
    LocalArray<index_type, NumDimensions> coords;
  } local_coords_t;
...
public:
  ...
  SimpleBlockPattern(
    ...
    /// types.
    Args && ... args)
  : SimpleBlockPattern(PatternArguments_t(arg, args...))
  {
    DASH_LOG_TRACE("SimpleBlockPattern()", "Constructor with argument list");
    initialize_local_range();
    DASH_LOG_TRACE("SimpleBlockPattern()", "SimpleBlockPattern initialized");
  }
  ...
  {
    DASH_LOG_TRACE("SimpleBlockPattern()", "(sizespec, dist, teamspec, team)");
    initialize_local_range();
    DASH_LOG_TRACE("SimpleBlockPattern()", "SimpleBlockPattern initialized");
  }
  ...
  SimpleBlockPattern(
    ...
    , _local_capacity(initialize_local_capacity())
  {
    DASH_LOG_TRACE("SimpleBlockPattern()", "(sizespec, dist, team)");
    initialize_local_range();
    DASH_LOG_TRACE("SimpleBlockPattern()", "SimpleBlockPattern initialized");
  }
    ...
    _lend(other._lend)
  {
    ...
    DASH_LOG_TRACE("SimpleBlockPattern(other)", "SimpleBlockPattern copied");
  }
   ...
   * copy-construction.
   */
  SimpleBlockPattern(self_t & other)
  : SimpleBlockPattern(static_cast<const self_t &>(other))
  { }
   ...
   * Assignment operator.
   */
  SimpleBlockPattern & operator=(const SimpleBlockPattern & other)
  {
    ...
    if (this != &other) {
      ...
      _lbegin              = other._lbegin;
      _lend                = other._lend;
      DASH_LOG_TRACE("SimpleBlockPattern.=(other)", "SimpleBlockPattern assigned");
    }
    return *this;
  }
    ...
    const ViewSpec_t & viewspec) const
  {
    ...
    LocalArray<IndexType, NumDimensions> vs_coords;
    ...
    const LocalArray<IndexType, NumDimensions> & coords) const
  {
    ...
    DASH_LOG_TRACE("SimpleBlockPattern.unit_at",
                   "coords", coords,
                   "> unit id", unit_id);
    return unit_id;
  }
   ...
   * \see  DashPatternConcept
   */
  constexpr LocalArray<SizeType, NumDimensions> local_extents() const noexcept
  {
   ...
   * \see  DashPatternConcept
   */
  FN_HOST_ACC local_index_t local(
    IndexType g_index) const
  {
    DASH_LOG_TRACE_VAR("SimpleBlockPattern.local()", g_index);
    ...
    const LocalArray<IndexType, NumDimensions> & global_coords) const
  {
    ...
    DASH_LOG_TRACE_VAR("SimpleBlockPattern.local_index", unit);
  ...
  FN_HOST_ACC LocalArray<IndexType, NumDimensions> global(
    ...
    const LocalArray<IndexType, NumDimensions> & local_coords) const
  {
    DASH_LOG_DEBUG_VAR("SimpleBlockPattern.global()", local_coords);
    if (_teamspec.size() < 2) {
      return local_coords;
    }
    // Coordinates of the unit within the team spec:
    LocalArray<IndexType, NumDimensions> unit_ts_coord =
      _teamspec.coords(unit);
    // Index of the element:
    LocalArray<IndexType, NumDimensions> glob_index{};
    for (auto d = 0; d < NumDimensions; ++d) {
    ...
    DASH_LOG_DEBUG_VAR("SimpleBlockPattern.global >", glob_index);
    return glob_index;
  }
   ...
   */
  IndexType global_at(
    const LocalArray<IndexType, NumDimensions> & view_coords,
    const ViewSpec_t                           & viewspec) const
  {
    DASH_LOG_TRACE("SimpleBlockPattern.global_at()",
    ...
    DASH_LOG_TRACE_VAR("SimpleBlockPattern.global_at >", offset);
    return offset;
  }
   ...
   */
  IndexType at(
    const LocalArray<IndexType, NumDimensions> & global_coords,
    const ViewSpec_t & viewspec) const
  {
    ...
    DASH_LOG_TRACE_VAR("SimpleBlockPattern.at()", coords);
    DASH_LOG_TRACE_VAR("SimpleBlockPattern.at()", viewspec);
    return at(coords);
  }
  ...
  IndexType at(IndexType value, Values ... values) const
  {
    ...
    LocalArray<IndexType, NumDimensions> inputindex = {
  ...
  bool has_local_elements(
    ...
    const ViewSpec_t & viewspec) const
  {
    DASH_LOG_TRACE_VAR("SimpleBlockPattern.has_local_elements()", dim);
    DASH_LOG_TRACE_VAR("SimpleBlockPattern.has_local_elements()", dim_offset);
    DASH_LOG_TRACE_VAR("SimpleBlockPattern.has_local_elements()", unit);
    ...
    DASH_LOG_TRACE_VAR("SimpleBlockPattern.has_local_elements", block_coord_d);
    // Coordinate of unit in team spec in given dimension
    IndexType teamspec_coord_d = block_coord_d % _teamspec.extent(dim);
    DASH_LOG_TRACE_VAR("SimpleBlockPattern.has_local_elements()",
                       teamspec_coord_d);
    ...
    team_unit_t unit) const
  {
    ...
    DASH_LOG_TRACE_VAR("SimpleBlockPattern.is_local >", (coords_unit == unit));
  ...
  index_type block_at(
    ...
    const LocalArray<index_type, NumDimensions> & g_coords) const
  {
    LocalArray<index_type, NumDimensions> block_coords{};
    // Coord to block coord to unit coord:
    for (auto d = 0; d < NumDimensions; ++d) {
    ...
    DASH_LOG_TRACE("SimpleBlockPattern.block_at",
                   "coords", g_coords,
    ...
    const LocalArray<index_type, NumDimensions> & g_coords) const
  {
    ...
    LocalArray<IndexType, NumDimensions> l_block_coords{};
    LocalArray<IndexType, NumDimensions> unit_ts_coords{};
    ...
    DASH_LOG_TRACE("SimpleBlockPattern.local_block_at >",
                   "coords",             g_coords,
                   "unit:",              l_pos.unit,
    ...
    index_type global_block_index) const
  {
    ...
    LocalArray<index_type, NumDimensions> offsets{};
    LocalArray<size_type, NumDimensions>  extents{};
    ...
    index_type local_block_index) const
  {
    ...
    LocalArray<SizeType, NumDimensions>  block_vs_extents =
      _blocksize_spec.extents();
    LocalArray<IndexType, NumDimensions> block_vs_offsets {{ }};
    ...
    index_type local_block_index) const
  {
    ...
    auto l_block_coords = _local_blockspec.coords(local_block_index);
    LocalArray<index_type, NumDimensions> offsets;
    LocalArray<size_type, NumDimensions>  extents = _blocksize_spec.extents();
   ...
   * \see DashPatternConcept
   */
  constexpr LocalArray<IndexType, NumDimensions> coords(
    IndexType index) const noexcept
  {
...
private:
  ...
  {
    DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_blocksizespec", teamspec.size());
    if (teamspec.size() == 0) {
      return BlockSizeSpec_t();
    }
    // Extents of a single block:
    LocalArray<SizeType, NumDimensions> s_blocks{};
    for (auto d = 0; d < NumDimensions; ++d) {
    ...
    const BlockSizeSpec_t    & blocksizespec) const
  {
    ...
    // Number of blocks in all dimensions:
    LocalArray<SizeType, NumDimensions> n_blocks{};
    for (auto d = 0; d < NumDimensions; ++d) {
      DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_blockspec", distspec[d].type);
    ...
    DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_blockspec", n_blocks);
    ...
    const LocalMemoryLayout_t & local_mem_layout) const
  {
    ...
    DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_local_blockspec", num_l_blocks);
  ...
  SizeType initialize_local_capacity() const
  {
    ...
    for (auto d = 0; d < NumDimensions; ++d) {
      ...
      auto max_l_blocks_d = dash::math::div_ceil(
                              num_blocks_d,
                              num_units_d);
      DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_lcapacity.d", d);
      DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_lcapacity.d", num_units_d);
      DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_lcapacity.d", max_l_blocks_d);
      l_capacity *= max_l_blocks_d;
    }
    l_capacity *= _blocksize_spec.size();;
    DASH_LOG_DEBUG_VAR("SimpleBlockPattern.init_lcapacity >", l_capacity);
    return l_capacity;
  }
  ...
  void initialize_local_range()
  {
    ...
    DASH_LOG_DEBUG_VAR("SimpleBlockPattern.init_local_range()", l_size);
    if (l_size == 0) {
      _lbegin = 0;
      _lend   = 0;
    } else {
    ...
    DASH_LOG_DEBUG_VAR("SimpleBlockPattern.init_local_range >", _lbegin);
    DASH_LOG_DEBUG_VAR("SimpleBlockPattern.init_local_range >", _lend);
  }
      ...
      team_unit_t unit) const
  {
    ...
    DASH_LOG_DEBUG_VAR("SimpleBlockPattern.init_local_extents()", _nunits);
    if (_nunits == 0) {
      return LocalArray<SizeType, NumDimensions> {{ }};
    }
    // Coordinates of local unit id in team spec:
    auto unit_ts_coords = _teamspec.coords(unit);
    DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_local_extents", unit_ts_coords);
    LocalArray<SizeType, NumDimensions> l_extents{};
    for (auto d = 0; d < NumDimensions; ++d) {
      ...
      DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_local_extents.d", d);
      DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_local_extents.d", unit_ts_coord);
      DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_local_extents.d", num_elem_d);
      DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_local_extents.d", num_units_d);
      DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_local_extents.d", num_blocks_d);
      DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_local_extents.d", blocksize_d);
      DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_local_extents.d",
                         min_local_blocks_d);
      ...
      if (num_blocks_d == 1 && num_units_d == 1) {
        ...
        DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_local_extents.d",
                           last_block_unit_d);
        DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_local_extents.d", num_add_blocks);
        if (unit_ts_coord < num_add_blocks) {
          // Unit is assigned to an additional block:
          l_extents[d] += blocksize_d;
          DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_local_extents.d", l_extents[d]);
        }
        if (unit_ts_coord == last_block_unit_d) {
          ...
          DASH_LOG_TRACE_VAR("SimpleBlockPattern.init_local_extents",
                             undfill_blocksize_d);
    ...
    DASH_LOG_DEBUG_VAR("SimpleBlockPattern.init_local_extents >", l_extents);
    return l_extents;
  }
};
...
#endif  // DASH__SIMPLE_BLOCK_PATTERN_H_
