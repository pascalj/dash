    ...
    Projection&& projection)
{
  ...
  std::vector<size_t> send_counts = send_displs;

  // The send counts can be calculated by the differences between send
  // displacements, rotated 1 to the right.
  ...
  DASH_LOG_TRACE_RANGE("remote units", remote_units.begin(), remote_units.end());
  ...
  DASH_LOG_TRACE("finished alltoallv", true);
